...
public class AppSpecification {
	...
	public static Specification<AppEntity> getSelect(final Map<String, Object> keyword) {
		return new Specification<AppEntity>() {
			...
			@Override
			public Predicate toPredicate(Root<AppEntity> root, CriteriaQuery<?> criteria, CriteriaBuilder builder) {
	...
	public static Specification<AppEntity> getDatatable(final Map<String, Object> keyword) {
		return new Specification<AppEntity>() {
