...
public class UserSpecification {
	...
	public static Specification<UserEntity> getSelect(final Map<String, Object> keyword) {
		return new Specification<UserEntity>() {
						...
						if (value != null) {
							switch (key) {
								...
								case "email" :
									...
									break;
								case "_all" :
									predicate.getExpressions().add(builder.like(builder.upper(root.<String>get("branchCode")), String.format("%%%s%%", value.toString().toUpperCase())));
									predicate.getExpressions().add(builder.like(builder.upper(root.<String>get("branchName")), String.format("%%%s%%", value.toString().toUpperCase())));
									break;
								default :
									break;
							}
