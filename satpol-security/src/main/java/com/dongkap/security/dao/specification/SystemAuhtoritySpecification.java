...
public class SystemAuhtoritySpecification {
	
	private static final String IS_ACTIVE = "active";

	public static Specification<SystemAuthorityEntity> getSelect(final Map<String, Object> keyword) {
		return new Specification<SystemAuthorityEntity>() {
			...
			@Override
			public Predicate toPredicate(Root<SystemAuthorityEntity> root, CriteriaQuery<?> criteria, CriteriaBuilder builder) {
	...
	public static Specification<SystemAuthorityEntity> getDatatable(final Map<String, Object> keyword) {
		return new Specification<SystemAuthorityEntity>() {
						...
						if (value != null) {
							switch (key) {
								...
								case "code" :
									...
									break;
								case "_all" :
									predicate.getExpressions().add(builder.like(builder.upper(root.<String>get("code")), String.format("%%%s%%", value.toString().toUpperCase())));
									predicate.getExpressions().add(builder.like(builder.upper(root.<String>get("name")), String.format("%%%s%%", value.toString().toUpperCase())));
									break;
								default :
									break;
